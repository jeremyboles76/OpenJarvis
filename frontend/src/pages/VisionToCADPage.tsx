      ...
      <div className="max-w-5xl mx-auto">
        ...
        <header className="mb-8">
          ...
          <p className="text-sm mt-3 max-w-2xl leading-relaxed" style={{ color: 'var(--color-text-secondary)' }}>
            Upload a sketch or photo. Solomon will extract dimensions, features, and geometry —
            you confirm or correct, and every correction becomes a training example.
          </p>
        </header>

        {/* Main workflow area */}
        {phase === 'idle' && renderUpload()}
        {phase === 'extracting' && renderExtracting()}
        {(phase === 'reviewing' || phase === 'saving') && renderReview()}
        {phase === 'confirmed' && renderConfirmed()}
